...
//合约地址：0xb952ba3e0dc941ef79e88c9bc04eecd35bcc4734
```
#### 1.2 部署艺术家合约

选择Artist合约，开始部署：
```
Deploy("0xb952ba3e0dc941ef79e88c9bc04eecd35bcc4734") //传入管理员团队合约地址
//合约地址：0x8eeccc73e11546e29a39f412a070803cd69b4d22
```
...
选择Works合约，开始部署：
```
Deploy("0xb952ba3e0dc941ef79e88c9bc04eecd35bcc4734","0x8eeccc73e11546e29a39f412a070803cd69b4d22") //传入管理员团队、艺术家合约地址
//合约地址：0xd13a77ba6eaf9d88dfe10dae1c7097194573dea0
```
...
选择Platform合约，开始部署：
```
Deploy("0xe95651358BeE7106a206Bb9B61D0BC406c58707a","0xb952ba3e0dc941ef79e88c9bc04eecd35bcc4734") //传入基金会钱包地址、管理员团队合约地址
//合约地址：0x2495700587037ba7b36a33fee1807624c752f1fe
```
...
选择Player合约，开始部署：
```
Deploy("0xb952ba3e0dc941ef79e88c9bc04eecd35bcc4734", "0xd13a77ba6eaf9d88dfe10dae1c7097194573dea0") //传入管理员团队、作品碎片合约地址
//合约地址：0xddbd018b7ad78dcbe834924865ec25bb4a4f33b5
```
...
选择PuzzleBID合约，开始部署：
```
Deploy("0xb952ba3e0dc941ef79e88c9bc04eecd35bcc4734", "0x2495700587037ba7b36a33fee1807624c752f1fe","0x8eeccc73e11546e29a39f412a070803cd69b4d22","0xd13a77ba6eaf9d88dfe10dae1c7097194573dea0","0xddbd018b7ad78dcbe834924865ec25bb4a4f33b5") //传入管理员团队、平台、艺术家、作品碎片、玩家合约地址
//合约地址：0x1e1818f71fd07f6884538532c67cd75282ea34bd
```
---
...
```
addAdmin("0x8eeccc73e11546e29a39f412a070803cd69b4d22",false,true,"0x61727469737400000000000000000000") //artist
addAdmin("0xd13a77ba6eaf9d88dfe10dae1c7097194573dea0",false,true,"0x776f726b730000000000000000000000") //works
addAdmin("0x2495700587037ba7b36a33fee1807624c752f1fe",false,true,"0x706c6174666f726d0000000000000000") //platform
addAdmin("0xddbd018b7ad78dcbe834924865ec25bb4a4f33b5",false,true,"0x706c6179657200000000000000000000") //player
addAdmin("0x1e1818f71fd07f6884538532c67cd75282ea34bd",false,true,"0x70757a7a6c6562696400000000000000") //puzzlebid
```
