...
//合约地址：0xb1706ddf103c9f6a87d8080bb5a675edbbbfeee1
```
...
选择Artist合约，开始部署：
```
Deploy("0xb1706ddf103c9f6a87d8080bb5a675edbbbfeee1") //传入管理员团队合约地址
//合约地址：0x5de85d966b15f09ebabdc516d4f9e1da697acd94
```
...
选择Works合约，开始部署：
```
Deploy("0xb1706ddf103c9f6a87d8080bb5a675edbbbfeee1","0x5de85d966b15f09ebabdc516d4f9e1da697acd94") //传入管理员团队、艺术家合约地址
//合约地址：0x4d2b1d93105c4c8c809e5f00fdab5e30bb7c99ad
```
...
选择Platform合约，开始部署：
```
Deploy("0xe95651358BeE7106a206Bb9B61D0BC406c58707a","0xb1706ddf103c9f6a87d8080bb5a675edbbbfeee1") //传入基金会钱包地址、管理员团队合约地址
//合约地址：0x9a8582c9b7636744c03ac898fd5449a9cf60d247
```
...
选择Player合约，开始部署：
```
Deploy("0xb1706ddf103c9f6a87d8080bb5a675edbbbfeee1", "0x4d2b1d93105c4c8c809e5f00fdab5e30bb7c99ad") //传入管理员团队、作品碎片合约地址
//合约地址：0x8e2ca96efda7e26681c7cecb444fde628f699528
```
...
选择PuzzleBID合约，开始部署：
```
Deploy("0xb1706ddf103c9f6a87d8080bb5a675edbbbfeee1", "0x9a8582c9b7636744c03ac898fd5449a9cf60d247","0x5de85d966b15f09ebabdc516d4f9e1da697acd94","0x4d2b1d93105c4c8c809e5f00fdab5e30bb7c99ad","0x8e2ca96efda7e26681c7cecb444fde628f699528") //传入管理员团队、平台、艺术家、作品碎片、玩家合约地址
//合约地址：0x798131748a6abb04bfc1e0112aa41aafca73855a
```
---
...
```
addAdmin("0x5de85d966b15f09ebabdc516d4f9e1da697acd94",false,true,"0x61727469737400000000000000000000") //artist
addAdmin("0x4d2b1d93105c4c8c809e5f00fdab5e30bb7c99ad",false,true,"0x776f726b730000000000000000000000") //works
addAdmin("0x9a8582c9b7636744c03ac898fd5449a9cf60d247",false,true,"0x706c6174666f726d0000000000000000") //platform
addAdmin("0x8e2ca96efda7e26681c7cecb444fde628f699528",false,true,"0x706c6179657200000000000000000000") //player
addAdmin("0x798131748a6abb04bfc1e0112aa41aafca73855a",false,true,"0x70757a7a6c6562696400000000000000") //puzzlebid
```
...
addWorks("0x41323031383131303232303500000000","0x5a68616e67205969204e616e000000000000","6","600000000000000","1544537400")
```
