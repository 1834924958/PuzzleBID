...
//合约地址：0x0729c3e67738be4592076e314760a194b868772c
```
#### 1.2 部署艺术家合约

选择Artist合约，开始部署：
```
Deploy("0x0729c3e67738be4592076e314760a194b868772c") //传入管理员团队合约地址
//合约地址：0xce26a1eef0b2db34a3c212919216258cd7260fb0
```
...
选择Works合约，开始部署：
```
Deploy("0x0729c3e67738be4592076e314760a194b868772c","0xce26a1eef0b2db34a3c212919216258cd7260fb0") //传入管理员团队、艺术家合约地址
//合约地址：0x6288462860ea0eaebe49f3f9f3aa237ac726d421
```
...
选择Platform合约，开始部署：
```
Deploy("0xe95651358BeE7106a206Bb9B61D0BC406c58707a","0x0729c3e67738be4592076e314760a194b868772c") //传入基金会钱包地址、管理员团队合约地址
//合约地址：0xe728620cd31a340eaf654333eb491b4ba44a711c
```
...
选择Player合约，开始部署：
```
Deploy("0x0729c3e67738be4592076e314760a194b868772c", "0x6288462860ea0eaebe49f3f9f3aa237ac726d421") //传入管理员团队、作品碎片合约地址
//合约地址：0x8bf93593817eacb375b7e43043b9222d8c15c0a2
```
...
选择PuzzleBID合约，开始部署：
```
Deploy("0x0729c3e67738be4592076e314760a194b868772c", "0xe728620cd31a340eaf654333eb491b4ba44a711c","0xce26a1eef0b2db34a3c212919216258cd7260fb0","0x6288462860ea0eaebe49f3f9f3aa237ac726d421","0x8bf93593817eacb375b7e43043b9222d8c15c0a2") //传入管理员团队、平台、艺术家、作品碎片、玩家合约地址
//合约地址：0x3fbcaf194dba2621a54f24d9af8344edf1a438cf
```
---
...
```
addAdmin("0xce26a1eef0b2db34a3c212919216258cd7260fb0",false,true,"0x61727469737400000000000000000000") //artist
addAdmin("0x6288462860ea0eaebe49f3f9f3aa237ac726d421",false,true,"0x776f726b730000000000000000000000") //works
addAdmin("0xe728620cd31a340eaf654333eb491b4ba44a711c",false,true,"0x706c6174666f726d0000000000000000") //platform
addAdmin("0x8bf93593817eacb375b7e43043b9222d8c15c0a2",false,true,"0x706c6179657200000000000000000000") //player
addAdmin("0x3fbcaf194dba2621a54f24d9af8344edf1a438cf",false,true,"0x70757a7a6c6562696400000000000000") //puzzlebid
```
...
```
addWorks("0x0701e6555cbb36e24c3c1f32cbf89ecf","0xe28a246d965078e969553e85d38e4b28","6","600000000000000","1544085000")
